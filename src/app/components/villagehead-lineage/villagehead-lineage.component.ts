...
@Component({
  selector: 'app-villagehead-lineage',
  standalone: true,
  ...
  templateUrl: './villagehead-lineage.component.html',
  styleUrl: './villagehead-lineage.component.scss',
})
export class VillageheadLineageComponent {
