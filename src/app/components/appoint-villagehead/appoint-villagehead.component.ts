...
@Component({
  selector: 'app-appoint-villagehead',
  standalone: true,
  imports: [MaterialModule],
  templateUrl: './appoint-villagehead.component.html',
  styleUrl: './appoint-villagehead.component.scss',
})
export class AppointVillageheadComponent {
